    ...
    <div className="space-y-3.5 mb-4">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        ...
        <div className="md:col-span-3 relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-md group">
          {slides.map((slide, index) => (
            <div
              key={index}
              className={`absolute inset-0 bg-gradient-to-r ${slide.bgGradient} p-6 sm:p-10 flex flex-col justify-center text-white transition-opacity duration-700 ease-in-out ${
        ...
        <div className="hidden md:flex flex-col gap-2.5">
          <button
            ...
            className="flex-1 bg-gradient-to-br from-[#f68b1e] to-[#e53935] rounded-xl p-4 text-white flex flex-col items-center justify-center text-center shadow-xs hover:shadow-md hover:scale-[1.02] transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="flex-1 bg-gradient-to-br from-[#1565c0] to-[#6a1b9a] rounded-xl p-4 text-white flex flex-col items-center justify-center text-center shadow-xs hover:shadow-md hover:scale-[1.02] transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="flex-1 bg-gradient-to-br from-[#2e7d32] to-[#00acc1] rounded-xl p-4 text-white flex flex-col items-center justify-center text-center shadow-xs hover:shadow-md hover:scale-[1.02] transition-all cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
        <button
          ...
          className="bg-gradient-to-r from-[#e53935] to-[#c62828] text-white p-4 rounded-xl flex items-center gap-3.5 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all text-left cursor-pointer"
        >
        ...
        <button
          ...
          className="bg-gradient-to-r from-[#1976d2] to-[#0d47a1] text-white p-4 rounded-xl flex items-center gap-3.5 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all text-left cursor-pointer"
        >
        ...
        <button
          ...
          className="bg-gradient-to-r from-[#388e3c] to-[#1b5e20] text-white p-4 rounded-xl flex items-center gap-3.5 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all text-left cursor-pointer"
        >
