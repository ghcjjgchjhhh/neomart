        ...
        <form onSubmit={handleSubmitOrder} className="p-4 sm:p-6 space-y-5 text-xs">
          ...
          <div className="border border-gray-200 dark:border-gray-700/80 rounded-xl p-4 bg-gray-50/50 dark:bg-[#202024]/50 space-y-3">
            ...
            <div className="relative">
              ...
              <input type="text" value={delivery.city || ''} disabled={!delivery.lga} onChange={(event) => { setDelivery({ ...delivery, city: event.target.value, town: event.target.value, street: '', address: '' }); setTownSearch(event.target.value); }} placeholder={delivery.lga ? 'Type or search town/city' : 'Select an LGA first'} className="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#18181b] text-gray-800 dark:text-gray-200 focus:outline-none focus:border-[#f68b1e] disabled:opacity-50" />
            ...
            <div>
              ...
              <input type="text" value={delivery.street || ''} disabled={!delivery.city} onChange={(event) => { setDelivery({ ...delivery, street: event.target.value, address: event.target.value }); setStreetSearch(event.target.value); }} placeholder={delivery.city ? 'Type or search street' : 'Select a town or city first'} className="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#18181b] text-gray-800 dark:text-gray-200 focus:outline-none focus:border-[#f68b1e] disabled:opacity-50" />
