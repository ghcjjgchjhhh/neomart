  ...
  const handleCompleteOrder = (
    ...
    if (_deliveryDetails && auth?.currentUser && !auth.currentUser.isAnonymous) {
      ...
      const savedAddress: SavedAddress = {
        ...
        lga: _deliveryDetails.lga || '',
        city: _deliveryDetails.city,
        address: _deliveryDetails.address,
        town: _deliveryDetails.town || _deliveryDetails.city,
        street: _deliveryDetails.street || '',
        houseNumber: _deliveryDetails.houseNumber || '',
        apartment: _deliveryDetails.apartment || '',
        landmark: _deliveryDetails.landmark || '',
